...
const _layout = () => {
  return (
    <Tabs screenOptions={{
        ...
        <Tabs.Screen name="Provider_Home" 
            options={{
                title:'Home' ,
                headerShown:false,
                tabBarIcon: ({focused}) => (
        ...
        <Tabs.Screen name="Provider_Booking" 
            options={{
                title:'Bookings' ,
                headerShown:false,
                tabBarIcon: ({focused}) => (
        ...
        <Tabs.Screen name="Provider_Profile" 
            options={{
                title:'Profile' ,
                headerShown:false,
                tabBarIcon: ({focused}) => (
                    <TabIcon focused={focused} icon={require('../../assets/profile.png')} title={"Profile"} />
                ) 
        }} />
