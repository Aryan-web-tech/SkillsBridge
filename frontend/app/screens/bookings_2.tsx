...
//       {/* Header */}
//       <Text className="text-2xl font-semibold mb-4">Bookings</Text>

//       {/* Top Tabs */}
//       <View className="flex-row bg-gray-100 rounded-xl p-1 mb-4">
//         <TouchableOpacity
//           className={`flex-1 items-center py-2 rounded-xl ${activeTab === 'confirmed' ? 'bg-white' : ''}`}
//           onPress={() => setActiveTab('confirmed')}
//         >
//           <Text className={`text-sm ${activeTab === 'confirmed' ? 'font-bold' : 'text-gray-500'}`}>
//             Confirmed Bookings
//           </Text>
//         </TouchableOpacity>
//         <TouchableOpacity
//           className={`flex-1 items-center py-2 rounded-xl ${activeTab === 'requests' ? 'bg-white' : ''}`}
//           onPress={() => setActiveTab('requests')}
//         >
//           <Text className={`text-sm ${activeTab === 'requests' ? 'font-bold' : 'text-gray-500'}`}>
//             Job Requests
//           </Text>
//         </TouchableOpacity>
//       </View>
...
//               <TouchableOpacity className="mt-3 py-2 px-4 bg-blue-100 rounded-xl self-start">
//                 <Text className="text-blue-600 text-sm font-medium">View booking details</Text>
//               </TouchableOpacity>
//             </View>
//           ))}
...
//                   <Text className="font-semibold text-lg">{job.requester}</Text>
//                 </View>
//               </View>
